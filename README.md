...
them through Firebase Cloud Messaging (FCM).

```mermaid
flowchart LR
    GitLab["GitLab project"] -->|"Webhook + X-FCM-Token"| Relay["Comeet Notify"]
...
| `POST` | `/webhooks/gitlab` | Receive a GitLab event and send an FCM notification |
